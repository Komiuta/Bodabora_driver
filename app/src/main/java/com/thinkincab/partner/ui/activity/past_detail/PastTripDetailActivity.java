...
import com.thinkincab.partner.data.network.model.Payment;
import com.thinkincab.partner.data.network.model.Rating;
import com.thinkincab.partner.data.network.model.User_Past;
import com.thinkincab.partner.ui.bottomsheetdialog.invoice_show.InvoiceShowDialogFragment;
import com.thinkincab.partner.ui.fragment.dispute.DisputeCallBack;
import com.thinkincab.partner.ui.fragment.dispute.DisputeFragment;
...
import static com.thinkincab.partner.MvpApplication.DATUM_history;
import static com.thinkincab.partner.MvpApplication.DATUM_history_detail;
...
public class PastTripDetailActivity extends BaseActivity implements PastTripDetailIView, DisputeCallBack {
    ...
    public void onSuccess(HistoryDetail historyDetail) {
        ...
        textView2.setText("Type :"+historyDetail.getServiceType().getName());

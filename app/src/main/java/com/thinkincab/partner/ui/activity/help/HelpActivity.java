        ...
        if (!allPermissionsGranted) {
            ...
            if (somePermissionsForeverDenied) {
                ...
                alertDialogBuilder.setTitle("Permissões necessárias")
                        .setMessage("Você negou algumas das permissões necessárias para este app " +
                                "Por favor, abra as configurações, procure pelo app vá para permissões e permita-as.")
